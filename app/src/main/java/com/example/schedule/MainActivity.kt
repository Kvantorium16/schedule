    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        (models as ArrayList<Model>).add(
            Model(
                R.drawable.kvant3d,
                "3D-моделирование",
                "Создание прототипов устройств, создание моделей, работа с 3D- графикой и анимация конструкторских решений."
            )
        ...
        (models as ArrayList<Model>).add(
            Model(
                R.drawable.vrar,
                "VR/AR-квантум",
                "Создание приложений виртуальной и дополненной реальности на игровой платформе. Работа с очками и шлемами дополненной и виртуальной реальности."
            )
        ...
        (models as ArrayList<Model>).add(
            Model(
                R.drawable.nano,
                "Наноквантум",
                "Изучение современных методов и средств лазерной технологии, работа на лазерном оборудовании."
            )
